...
#this is a stab a BMP180 driver.

import smbus
import time  

bus = smbus.SMBus(1) #the B+ uses 1, not 0
address = 0x77  #address of the BMP180
...
print "Temp: ", (t/ 10.0) * (9.0/5.0) + 32.0, "degrees F"

b6 = b5 - 4000 ; #print "b6 = ", b6
x1 = (b2 * (b6 * b6 >> 12)) >> 11 ; #print "x1 = ",x1
x2 = ac2 * b6 >> 11 ; #print "b6x2 = ",x2
x3 = x1 + x2 ; #print "x3 = ",x3
b3 = (((ac1 * 4 + x3) << oss) + 2) >> 2 ; #print "b3 = ",b3

x1 = (ac3 * b6) >> 13 ; #print "x1 = ",x1
x2 = (b1 * (b6 * b6 >> 12)) >> 16 ; #print "x2 = ",x2
x3 = ((x1 + x2) + 2) >> 2 ; #print "x3 = ",x3
b4 = ac4 * (x3 + 32768) >> 15 ; #print "b4 = ",b4
b7 = (pressure_raw - b3) * (50000 >> oss) ; #print "b7 = ",b7
if (b7 < 0x80000000):
    p = (b7 * 2) /b4 ; #print "p = ",p
else:
    p = (b7 / b4) *2 ; #print "p1 = ",p
x1 = (p >> 8) * (p >> 8) ; #print "x1 = ",x1
x1 = (x1 * 3038) >> 16 ; #print "x1 = ",x1
x2 = (-7357 * p) >> 16 ; #print "x2 = ",x2
p = p + ((x1 + x2 + 3791) >> 4)


print "Pressure = ",p,"Pa"
print "Pressure = ",round(p/3386.389,2),"inHg"